...
class McpConnectionConfig {
  ...
  static const String documentation = ''
      'Этот JSON описывает, как gen подключается к MCP-серверу. Должен быть корректным JSON: двойные кавычки у строк, запятые между ключами, пустые массивы [] и объекты {} допустимы.\n'
      '\n'
      'Поля:\n'
      ...
      '\n'
      'Режимы:\n'
      '  stdio: задайте transport, command, args, при необходимости env; url и headers обычно пустые.\n'
      '  Удалённый сервер: задайте transport (sse или streamable) и url; при необходимости headers - command и args не используются.\n'
      '\n'
